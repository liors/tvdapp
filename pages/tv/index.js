...
export default class GridListExampleSimple extends Component {
    static async getInitialProps() {
        const res = await fetch('http://localhost:3020/api/shows/air')
    ...
    render() {       
        ...
        return (
            ...
            <div className={`fl w-50 pr2 pr3-l mb3 mb4-l`}>
              <div className={`cover pv5 pv6-m pv7-l`} style={{background:`black url(${shows[0].img.original}) center`}}></div>
            </div>
            <div className={`fl w-50 w-25-l pl2 pr2-m ph2-l mb3 mb4-l`}>
              <div className={`cover pv5 pv6-m pv7-l`} style={{background: `black url(${shows[1].img.original}) center`}}> </div>
            </div>
            <div className={`fl w-50 w-50 w-25-l pr2 pr0-l pl3-l mb3 mb4-l`}>
                <div className={`cover pv5 pv6-m pv7-l`} style={{background: `black url(${shows[2].img.original}) left`}}> </div>
              </div>
            <div className={`fl w-50 w-50 w-25-l pl2 pl0-l pr2-m pr4-l mb3 mb4-l`}>
              <div className={`cover pv5 pv6-m pv7-l`} style={{background: `black url(${shows[3].img.original}) center`}}> </div>
            </div>
            ...
            <div className={`cf`}>
              <div className={`fl w-100 w-25-l pl3-l mb3 mb4-l`}>
                  <div className={`cover pv5 pv6-m pv7-l`} style={{background: 'black url(http://mrmrs.github.io/photos/051.jpg) center;'}}> </div>
              </div>
              ...
              <div className={`fl w-100 w-75-l pv0 mv0`}>
                <div className={`fl w-100 mb2 mb4-l`}>
                  <div className={`cover pv5 pv6-l`} style={{background: 'black url(http://mrmrs.github.io/photos/u/001.jpg) center;'}}> </div>
                </div>
                <div className={`fl w-25 mb2 mb4-l`}>
                  <div className={`cover pv5 pv6-m pv7-l`} style={{background: 'black url(http://mrmrs.github.io/photos/u/002.jpg) center;'}}> </div>
                </div>
                <div className={`fl w-75 pl2 pl4-l mb2 mb4-l`}>
                  <div className={`cover pv5 pv6-m pv7-l`} style={{background: 'black url(http://mrmrs.github.io/photos/u/003.jpg) center;'}}> </div>
                </div>
                <div className={`fl w-100 mb2 mb4-l`}>
                    <div className={`cover pv5 pv6-ns`} style={{background: 'black url(http://mrmrs.github.io/photos/u/004.jpg) center;'}}> </div>
                </div>
              </div>
            </div>
        </main>
